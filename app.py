...
def show_artist(artist_id):
  ...
  data1={
    ...
    "state": "CA",
    "phone": "326-123-5000",
    "website": "https://images.unsplash.com/photo-1485686531765-ba63b07845a7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=747&q=80ttps://www.gunsnpetalsband.com",
...
@app.route('/shows')
def shows():
  return render_template('pages/shows.html', show=Show.query.all())
